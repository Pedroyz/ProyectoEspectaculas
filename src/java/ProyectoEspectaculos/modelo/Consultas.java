...
public class Consultas extends ConexionBBDD {
    ...
    public boolean ExisteUser(String user) throws SQLException {
        ...
        while (rs.next()) {
            //la bbdd no deja meter dos nombre iguales si son iguales aunque tenga mayusculas..
            if (user.toUpperCase().equals(rs.getString("usuario").toUpperCase())) {
                return true;
            }
        }
...
/*
    public static void main(String argv[]) throws SQLException {
        ...
        System.out.println(con.ExisteUser("Pedro"));
